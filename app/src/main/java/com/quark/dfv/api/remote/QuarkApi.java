package com.quark.dfv.api.remote;
...
import com.quark.dfv.api.ApiHttpClient;
import com.quark.dfv.ui.chooseImage.FileItem;
...
public class QuarkApi {
    ...
    public static String sign(List<MD5Item> dlist) {
        ...
        String sign = EncryptionKit.md5Encrypt(signStr).toUpperCase();
        return sign;
    }
