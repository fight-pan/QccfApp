...
public class CarUserAdapter extends RecyclerView.Adapter<CarUserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (position == 0) {
            holder.iv.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.em_default_avatar));
            holder.tv.setText("违章查询");
        }
        if (position == 1) {
            holder.iv.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.em_add_public_group));
            holder.tv.setText("身份证识别");
        }
        if (position == 2) {
            holder.iv.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.em_group_icon));
            holder.tv.setText("驾照识别");
        }
        if (position == 3) {
            holder.iv.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.em_create_group));
