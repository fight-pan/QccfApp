package com.quark.dfv.ui.smileyloadingview;
...
public class CustomHeader extends View implements IHeaderCallBack {
    ...
    private int[] colors = {0xFF0000FF, 0xFF0000FF
...
//        mDrawable.setColorSchemeColors(colors);
        mDrawable.setColorSchemeColors(ContextCompat.getColor(getContext(), R.color.red));

        //设置圈圈的各种大小
//        mDrawable.updateSizes(MaterialProgressDrawable.LARGE);
        mDrawable.setCallback(this);
        int padding = DensityUtil.dp2px(getContext(), 10);
